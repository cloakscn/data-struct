...
// 
//
// Related Topics 数组 双指针 字符串 👍 73 👎 0
 ...
 * @date 2023-01-16 17:48:18
 */
public class Code1813SentenceSimilarityIii {
    public static void main(String[] args) {
        System.out.println("hello world!");
        Solution solution = new Code1813SentenceSimilarityIii().new Solution();
    }
