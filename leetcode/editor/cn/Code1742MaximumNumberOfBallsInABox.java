 ...
 * @date 2022-11-23 21:32:51
 */
public class Code1742MaximumNumberOfBallsInABox {
    public static void main(String[] args) {
        System.out.println("hello world!");
        Solution solution = new Code1742MaximumNumberOfBallsInABox().new Solution();
        System.out.println(solution.countBalls(8, 16));
    }
    ...
    class Solution {
        public int countBalls(int lowLimit, int highLimit) {
            ...
            for (int i = lowLimit; i <= highLimit; i++) {
                ...
                Integer orDefault = hashMap.getOrDefault(number, 0);
                hashMap.put(number, ++orDefault);
                result = result > orDefault ? result : orDefault;
            }
            return result;
        }
    }
